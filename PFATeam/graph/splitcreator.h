...
* */
    ...
    template<EdgeContainer Container,template<typename> typename Allocator=std::allocator>
    class SequentialSplitCreator : public SplitCreator<Container,Allocator>
    {
    public:
        SequentialSplitCreator() : SplitCreator<Container,Allocator>(std::launch::deferred) {}
    };
    template<EdgeContainer Container,template<typename> typename Allocator=std::allocator>
    class ParallelSplitCreator : public SplitCreator<Container,Allocator>
    {
    public:
